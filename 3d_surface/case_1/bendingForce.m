...
% INPUTS: x_1 - position of the first node in the bending element
%         x_2 - position of the second node in the bending element
%         x_3 - poisiton of the third node in the bending element
%         x_4 - position of the fourth node in the bending element          
%         nBar_Scale - the natural curvature between two bending elements
%         EI - bending stiffness
%
% OUTPUTS: dF - bending forces (12 x 1)
%          dJ - bending jacobian (12 x 12)
